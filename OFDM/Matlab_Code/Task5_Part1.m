...
%                 OFDM symbol
                ...
                % Reciever
                % --------
%                 SampledSymbol = DelayedSymbol(1:Nfft);
            ...
            set(gca, 'FontSize',14); 
            title('FFT, OFDM Symbol, Channel Delay 1Ts')
...
%             axis([-f/2 f/2 -40 10])
            ...
            set(gca, 'FontSize',14); 
            title('FFT, OFDM Symbol, Channel Delay 18Ts')
            xlabel('Frequency (MHz)', 'FontSize',14);
            ylabel('Magnitude dB', 'FontSize',14);
%             axis([-f/2 f/2 -40 10])
            ...
            set(gca, 'FontSize',14); 
            title('FFT, OFDM Symbol, Channel Delay 36Ts')
            xlabel('Frequency (MHz)', 'FontSize',14);
            ylabel('Magnitude dB', 'FontSize',14);
%             axis([-f/2 f/2 -40 10])
            ...
            set(gca, 'FontSize',14); 
            title('FFT, OFDM Symbol, Channel Delay 37Ts')
            xlabel('Frequency (MHz)', 'FontSize',14);
            ylabel('Magnitude dB', 'FontSize',14);
%             axis([-f/2 f/2 -40 10])
            ...
            set(gca, 'FontSize',14); 
            title('Channel Delayed Constellation Diagram, Channel Delay 1Ts')
            ...
            set(gca, 'FontSize',14); 
            title('Channel Delayed Constellation Diagram, Channel Delay 18Ts')
            xlabel('I', 'FontSize',14);
            ylabel('Q', 'FontSize',14);
            axis([-1 1 -1 1])
            ...
            set(gca, 'FontSize',14); 
            title('Channel Delayed Constellation Diagram, Channel Delay 36Ts')
            xlabel('I', 'FontSize',14);
            ylabel('Q', 'FontSize',14);
            axis([-1 1 -1 1])
            ...
            set(gca, 'FontSize',14);  
            title('Channel Delayed Constellation Diagram, Channel Delay 37Ts')
            xlabel('I', 'FontSize',14);
            ylabel('Q', 'FontSize',14);
            axis([-1 1 -1 1]) 
            ...
            plot(F,20*log10(abs(fft(testArray(:,3),Nfft))))
            set(gca, 'FontSize',14); 
            title('Channel Delay 36Ts')
            xlabel('Frequency (MHz)', 'FontSize',14);
            ylabel('Magnitude dB', 'FontSize',14);
            axis([-f/2 f/2 -400 10])
            grid on
            subplot(2,1,2)
            plot(F,20*log10(abs(fft(testArray(:,4),Nfft))),'r')
            set(gca, 'FontSize',14); 
            title('Channel Delay 37Ts')
            xlabel('Frequency (MHz)', 'FontSize',14);
            ylabel('Magnitude dB', 'FontSize',14);
            axis([-f/2 f/2 -30 10])
            grid on
